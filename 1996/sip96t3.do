...
label define ealry   
	-1          "Not in universe for perons under"
	0           "None or not in universe"       
;
...
label define epvcomut
	-1          "Not in universe for EPOPSTAT=2"
	0           "Not in Universe for EPOPSTAT=1"
;
...
label define adaysick
	...
	3           "Logical imputation (derivation)"
;
label values tmedpay  tmedpay;
label define tmedpay 
	0           "Not in universe"               
;
label values amedpay  amedpay;
label define amedpay 
	0           "Not imputed"                   
	1           "Statistical imputation (hot"   
	2           "Cold deck imputation"          
	3           "Logical imputation (derivation)"
