...
label define aoaeq   
	...
	3           "Logical imputation (derivation)"
;
label values eiajtae  eiajtae;
label define eiajtae 
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
;
...
label define aiajta  
	...
	3           "Logical imputation (derivation)"
;
label values eiaitae  eiaitae;
label define eiaitae 
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
;
...
label define aiaita  
	...
	3           "Logical imputation (derivation)"
;
label values eimjae   eimjae; 
label define eimjae  
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
;
label values eimiae   eimiae; 
label define eimiae  
	-4          "Refused"                       
	-2          "Don't Know"                    
	-1          "Not in universe"               
...
label define arjdeb  
	...
	3           "Logical imputation (derivation)"
;
label values erjprie  erjprie;
label define erjprie 
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
	1           "Less than $25,000"             
...
label define arideb  
	...
	3           "Logical imputation (derivation)"
;
label values eriprie  eriprie;
label define eriprie 
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
	1           "Less than $25,000"             
...
label define arttypep
	...
	3           "Logical imputation (derivation)"
;
label values ertat    ertat;  
label define ertat   
	-1          "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values artat    artat;  
label define artat   
	0           "Not imputed"                   
	1           "Statistical imputation (hot"   
	2           "Cold deck imputation"          
	3           "Logical imputation (derivation)"
;
label values ertata   ertata; 
label define ertata  
	-1          "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values artata   artata; 
label define artata  
	0           "Not imputed"                   
	1           "Statistical imputation (hot"   
	2           "Cold deck imputation"          
...
label define artpri  
	...
	3           "Logical imputation (derivation)"
;
label values ertshae  ertshae;
label define ertshae 
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
	1           "Less than $25,000"             
...
label define evbno1l 
	-1          "Not in universe"               
;
label values rprtner1 rprtnerp;
label define rprtnerp
	-1          "Not in universe"               
	0           "No partners"                   
	1           "1 partner"                     
	2           "2 partners"                    
...
label define avbow1l 
	...
	3           "Logical imputation (derivation)"
;
label values evbvaes1 evbvaesp;
label define evbvaesp
	-4          "Refused"                       
	-2          "Don't Know"                    
	-1          "Not in universe"               
;
...
label define avbva1l 
	...
	3           "Logical imputation (derivation)"
;
label values evbdees1 evbdeesp;
label define evbdeesp
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
;
...
label define evbno2l 
	-1          "Not in universe"               
;
label values rprtner2 rprtnerk;
label define rprtnerk
	-1          "Not in universe"               
	0           "No partners"                   
	1           "1 partner"                     
	2           "2 partners"                    
...
label define avbow2l 
	...
	3           "Logical imputation (derivation)"
;
label values evbvaes2 evbvaesk;
label define evbvaesk
	-4          "Refused"                       
	-2          "Don't Know"                    
	-1          "Not in universe"               
;
...
label define avbva2l 
	...
	3           "Logical imputation (derivation)"
;
label values evbdees2 evbdeesk;
label define evbdeesk
	-4          "Refused"                       
	-2          "Don't know"                    
	-1          "Not in universe"               
;
...
label define egrdrptl
	-3          "No other grades reported"      
	-1          "Not in universe"               
	0           "Fewer than three grades reported"
	1           "First grade"                   
	2           "Second grade"                  
	3           "Third grade"                   
	4           "Fourth grade"                  
...
label define egrdrptm
	-3          "No other grades reported"      
	-1          "Not in universe"               
	0           "Fewer than four grades reported"
	1           "First grade"                   
	2           "Second grade"                  
	3           "Third grade"                   
	4           "Fourth grade"                  
