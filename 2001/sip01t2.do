...
label define awhotrnm
	...
	3           "Logical imputation(derivation)"
;
label values tgovtrn1 tgovtrnm;
label define tgovtrnm
	-1          "Not in universe"               
	1           "Job Training Partnership"      
	2           "Job Opportunities and Basic"   
	4           "Food Stamps work/OTHER program"
...
label define awhotrnk
	...
	3           "Logical imputation(derivation)"
;
label values tgovtrn2 tgovtrnk;
label define tgovtrnk
	-1          "Not in universe"               
	1           "Job Training Partnership"      
	2           "Job Opportunities and Basic"   
	4           "Food Stamps work/OTHER program"
...
label define afbrthyr
	...
	4           "Imputed based on previous wave"
;
label values tagfbrth tagfbrth;
label define tagfbrth
	0           "Suppressed"                    
;
...
label define albirtyr
	...
	4           "Imputed based on previous wave"
;
label values taglbrth taglbrth;
label define taglbrth
	0           "Suppressed"                    
;
...
label define abfbstop
	...
	4           "Imputed based on previous wave"
;
label values tagestop tagestop;
label define tagestop
	0           "Suppressed"                    
;
...
label define aafbwkyk
	...
	4           "Imputed based on previous wave"
;
label values tagertwk tagertwk;
label define tagertwk
	0           "Suppressed"                    
;
...
label define aafblvyr
	...
	4           "Imputed based on previous wave"
;
label values tagelvem tagelvem;
label define tagelvem
	0           "Suppressed"                    
;
...
label define abrstate
	...
	3           "Logical imputation(derivation)"
;
label values tcitiznt tcitiznt;
label define tcitiznt
	-1          "Not in universe"               
	1           "Yes, native"                   
	2           "Yes, foreign-born, naturalized"
	3           "No, foreign-born, not a"       
;
...
label define eoutinmo
	-5          "Always lived there"            
	-1          "Not in universe or not a valid"
	99          "Respondent didn't supply valid"
;
